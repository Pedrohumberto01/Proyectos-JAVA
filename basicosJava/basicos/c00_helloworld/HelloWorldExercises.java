...
public class HelloWorldExercises {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hola pedroo");
        ...
        System.err.println("Warning"); // para mostrar error | Se muestra el texto en rojo
        System.out.println("Texto cualquieraaa"); // para mostrar texto de forma normal
